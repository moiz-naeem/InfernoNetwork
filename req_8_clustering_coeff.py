...
def analyze_clustering_coefficient_distribution(G):
    ...
    plt.tight_layout()
    plt.savefig("power_law_fit.png", dpi=300, bbox_inches="tight")
    plt.close()
    ...
    plt.ylabel("Frequency")
    plt.tight_layout()
    plt.savefig("truncated_power_law_fit.png", dpi=300, bbox_inches="tight")
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("fit_comparison_loglog.png", dpi=300, bbox_inches="tight")
    plt.close()
